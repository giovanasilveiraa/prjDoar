...
<body>
    ...
    <div class="container-div">
        <form action="" method="POST" class="form-control">
            ...
            <p>Colabore com os Doutores da Alegria</p>
            <p class="texto">
                <img class="rounded mx-auto d-block" src="../imagens/doutoresAlegria.jpg" width="10%" height="10%">
            </p>
            ...
            $sql="SELECT nome, cnpj, cidade, estado, descricao FROM instituicao WHERE idinstituicao = 3";
