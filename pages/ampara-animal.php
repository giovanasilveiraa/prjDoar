...
<body>
    ...
    <div class="container-div">
        <form action="" method="POST" class="form-control">
            ...
            <p>Colabore com o Ampara Animal</p>
            <p class="texto">
                <img class="rounded mx-auto d-block" src="../imagens/amparaAnimal.jpg" width="10%" height="10%">
            </p>

            <input type="hidden" name="idusuario" value="" id="idusuario">
            <input type="hidden" name="idinstituicao" value="4" id="idinstituicao">

            <?php
            include("../bd/conexao.php");
            $sql="SELECT nome, cnpj, cidade, estado, descricao FROM instituicao WHERE idinstituicao = 4";
